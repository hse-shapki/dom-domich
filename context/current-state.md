...
Продолжить G0 из [плана трёх пулов](implementation-plan.md): Алина делает A00 (Python-каркас), Катерина и Замира — K00/Z00 (предложения стыков), затем A01 закрепляет contracts. Параллельно Замира может развивать свои независимые чистые правила и fixtures; Z01 уже проверен на unit-уровне. Реальный доступ MAX/LLM и готовность интеграций проверяются отдельно.

...
Начать общий этап **S0** из [треков](../docs/engineering/07-workstreams.md) по отдельной задаче команды: Python-проект, общие contracts, синтетический дом и fixtures, доступ к MAX/LLM, проверка зависимостей. Затем треки A/B/C можно вести параллельно. Само наличие плана не разрешает считать эти работы выполненными.

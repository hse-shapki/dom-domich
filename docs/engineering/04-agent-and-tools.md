...
K07 `PostgresCaseReader` проверен на PostgreSQL 16: жёсткие фильтры дома,
...
совпадающей embedding revision; она пока не проверена на целевом PG17.
...
проверено на PostgreSQL 16, но A inbox и Z workflow ещё не подключены.

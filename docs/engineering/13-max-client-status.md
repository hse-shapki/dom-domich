...
Это частичная A03: нет фактического доступа к боту и тестовому чату, живой `/me` и send/edit/callback/upload smoke не выполнены. Физическая загрузка файла по выданному URL и ограничения host/redirect/size относятся к A11; сейчас `request_upload` только возвращает slot. При сборке A08/A11 нельзя считать получение slot доставкой файла. Для G1/G2 остаётся проверить реальный MAX в мобильном и веб-клиенте.

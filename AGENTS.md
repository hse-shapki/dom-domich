...
| K08: CaseService | Частично: create/attach/recurrence, events, idempotency и конкурентный dedupe проверены на PostgreSQL 16; evidence и A/Z wiring ещё нужны | `application/cases/service.py`, `infrastructure/postgres/case_writer.py`, `tests/infrastructure/test_k08_case_service.py` |

...
В репозитории есть проектная документация и первые независимые доменные правила опросов. Общий Python-проект и интеграции MAX/БД ещё не созданы; точное состояние — в [контексте](context/current-state.md).
